...
import { normalizeAboutData, type AboutData } from './about-types'

export default function Page() {
	const normalizedInitialData = normalizeAboutData(initialData)
	const [data, setData] = useState<AboutData>(normalizedInitialData)
	const [originalData, setOriginalData] = useState<AboutData>(normalizedInitialData)
			...
			<div className='flex flex-col items-center justify-center px-6 pt-32 pb-12 max-sm:px-0'>
				<div className='w-full max-w-[800px]'>
					...
					<div className='mt-8 flex items-center justify-center gap-6'>
						<motion.a
							href='https://github.com/lix965996-art/lix965996-art.github.io'
							target='_blank'
							rel='noreferrer'
