...
const ENDPOINT = process.env.NEXT_PUBLIC_LIKE_ENDPOINT || 'https://your-worker.your-domain.workers.dev/api/like'

export default function LikeButton({ slug = 'default', delay, className }: LikeButtonProps) {
